...
import com.rafaelvieira.clientsecurityjwt.filter.AuthenticationFilter;
import com.rafaelvieira.clientsecurityjwt.filter.AuthorizationFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/roles").hasAnyAuthority("ROLE_MASTER");
